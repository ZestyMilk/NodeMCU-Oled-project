...
#define SCL 6
#define OLED_RESET 5
Adafruit_SSD1306 display(SDA, OLED_RESET, SCL);
...
if (buttonPushCounter % 3 == 0) {
  if(temp == 151){
      display.clearDisplay();
      display.setCursor(0,16);
      display.println("Waiting for feed data");
      display.display();
      Serial.println(F("Printed: Waiting for feed data"));
  }else{
      display.clearDisplay();
      display.setCursor(0,16);
